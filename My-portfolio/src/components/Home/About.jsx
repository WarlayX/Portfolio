  ...
  return (
    <section className='pt-5'>
      <div className='flex flex-col gap-6 p-2.5 sm:flex-row sm:max-w-325 sm:mx-auto sm:items-center sm:h-85 lg:h-90'>
        ...
        <div className='sm:w-[25%] sm:flex sm:items-center justify-center sm:self-start'>
          <h2 className='text-(--color-primary) text-[20px] font-bold sm:text-[30px] self-center'>
            ABOUT
          </h2>
        </div>
